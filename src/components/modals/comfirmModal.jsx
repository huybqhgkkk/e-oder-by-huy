...
const ConfirmModal = ({ title, contentText, handleConfirmed }) => {
  const { t } = useTranslation();

    return (
        <div id="confirm-modal" className="hs-overlay hidden w-full h-full fixed top-1/3 left-0 z-[55] overflow-x-hidden overflow-y-auto" aria-overlay="true" tabIndex={-1}>
                    ...
                    <div className="flex justify-end items-center gap-2 p-4 border-t dark:border-slate-700">
                        ...
                        <button
                            ...
                            onClick={async () => {
                                ...
                                document.getElementById("btn-close-confirm-modal").click();
                            }}
                        >
                            {t("continue")}
                        </button>
