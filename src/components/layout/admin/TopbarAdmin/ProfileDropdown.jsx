...
import { avatarDefault } from "@/assets/data";
      ...
      <div className="hs-dropdown relative inline-flex">
        ...
        >
          <img
              ...
              alt={t("avatarAlt")}
              src={info?.avatarImgUrl || avatarDefault}
          />
          <div className="hidden text-start lg:block">
            <p className="text-sm font-medium text-default-700">{`${info?.firstName} ${info?.lastName}`}</p>
